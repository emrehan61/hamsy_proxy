...
/// `$RDPROXY_UI_DIR`, `<cwd>/ui/dist`, `<exe_dir>/ui/dist`.
fn resolve_ui_dir() -> Option<PathBuf> {
    if let Ok(dir) = std::env::var("RDPROXY_UI_DIR") {
...
<main>
  ...
  <p><a href="/cert/rdproxy-ca.crt">Download the rdproxy root CA certificate</a></p>
</main>
</body>
</html>
"#
