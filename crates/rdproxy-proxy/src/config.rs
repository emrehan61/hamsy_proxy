...
use rdproxy_core::{RuleSet, RulesStore, ServerEvent, Settings};
...
pub struct ProxyContext {
    ...
    pub flows: Arc<rdproxy_core::FlowStore>,
...
impl ProxyContext {
    ...
    /// Returns true if `host` should be captured (a [`Flow`](rdproxy_core::Flow)
